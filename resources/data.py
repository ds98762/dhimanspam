RAID = [
    ...
    "TERA PEHLA BAAP HU MADARCHOD #DHIMAN_OP",
    ...
    "TERI BHEN KI CHUT KAALI ME #DHIMAN KA KALA LNDD🙁🤣💥",
...
REPLYRAID = [
    ...
    "MADRCHOD.. TERA BAAP HU MAI #DHIMAN",
    "TERI MA KI CHUT.. ME #DHIMAN KA LODA",
    "LWDE KE BAAALLL.",
    "MACHAR KI JHAAT KE BAAALLLL",
    "TERI MA KI CHUT M DU TAPA TAP?",
    "TERI MA KA BHOSDAA FAAD DIYA #DHIMAN NE",
    "TERI BHN SBSBE BDI RANDI BNA DI #DHIMAN NE.",
    ...
    "HAHAHAAAAA",
    "KIDSSSS",
    "TERI MA CHOD DAALI #DHIMAN NE AB FRAR MT HONA",
    "YE LDNGE BAPP SE",
    "KIDSSS FRAR HAHAHH",
    "BHEN KE LWDE SHRM KR TERI MA NANGI KRR RAKHI HAI #DHIMAN NE",
    "#DHIMAN SE KITNI GLIYA PDWEGA APNI MA KO",
    "NALLEE",
    "SUAR KE PILLE TERI MAAKO SADAK PR LITAKE CHOD DUNGA 😂😆🤤",
    "ABE TERI MAAKA BHOSDA MADERCHOOD KR PILLE PAPA SE LADEGA TU 😼😂🤤",
    "GALI GALI NE SHOR HE TERI MAA RANDI CHOR HE 💋💋💦",
...
PORMS = [
        "https://telegra.ph/file/0fc760cb0777ea04b7dfe.jpg",
